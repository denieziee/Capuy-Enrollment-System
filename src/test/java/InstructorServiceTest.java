...
public class InstructorServiceTest {
    ...
    void testAddInstructor() throws DuplicateIdException {
        Instructor prof = new Instructor("INS-01", "Dr. Smith", "Computer Science");
        instructorService.addInstructor(prof);

        Instructor retrieved = instructorService.getInstructorDetails("INS-01");
    ...
    void testDuplicateInstructorId() throws DuplicateIdException {
        Instructor prof1 = new Instructor("INS-01", "Dr. Smith");
        Instructor prof2 = new Instructor("INS-01", "Prof. Jones");
    ...
    void testAssignInstructorToSection() {
        Instructor prof = new Instructor("INS-01", "Dr. Smith");
        Section section = new Section("BSIT-2C", 30);
